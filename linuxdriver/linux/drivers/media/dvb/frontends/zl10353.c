				  ...
				  struct dvb_frontend_parameters *param)
{
	...
	zl10353_single_write(fe, 0x5c, 0x75);
	zl10353_single_write(fe, 0x9c, 0xa1);
	zl10353_single_write(fe, 0x8e, 0x00);
	zl10353_single_write(fe, 0x90, 0x00);
	zl10353_single_write(fe, 0x91, 0xff);
	zl10353_single_write(fe, 0x92, 0xff);
	zl10353_single_write(fe, 0x93, 0x00);
	zl10353_single_write(fe, 0x94, 0xff);
	zl10353_single_write(fe, 0x58, 0x00);
	zl10353_single_write(fe, 0x95, 0x3f);
	zl10353_single_write(fe, 0x96, 0x3f);
	zl10353_single_write(fe, 0x5a, 0x0c);
	
	zl10353_single_write(fe, 0x56, 0x2b);
	zl10353_single_write(fe, 0x5f, 0x12);
	zl10353_single_write(fe, 0x5e, 0x40);
	zl10353_single_write(fe, 0x64, 0x36);
	zl10353_single_write(fe, 0x65, 0x67);
	zl10353_single_write(fe, 0x66, 0xe5);
	zl10353_single_write(fe, 0xcc, 0x73);
	zl10353_single_write(fe, 0x6c, 0xcd);
	zl10353_single_write(fe, 0x6d, 0x7e);

	zl10353_single_write(fe, 0x71, 0x01);
...
{
	struct zl10353_state *state = fe->demodulator_priv;
	u8 zl10353_reset_attach[6] = { 0x50, 0x0b, 0x44, 0x46, 0x15, 0x0F };
	int rc = 0;
