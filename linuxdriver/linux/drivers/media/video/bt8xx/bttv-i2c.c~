...
bttv_i2c_wait_done(struct bttv *btv)
{
	...
	if (wait_event_interruptible_timeout(btv->i2c_queue,
		btv->i2c_done, msecs_to_jiffies(100)) == -ERESTARTSYS)
...
bttv_i2c_sendbytes(struct bttv *btv, const struct i2c_msg *msg, int last)
{
	...
	/* set GPIO0 low */
	gpio_write(gpio_read() & 0xfffffffe);
 ...
 err:
	...
	/*if error,release the handshake line*/
	gpio_write(gpio_read() | 0x01);
	return retval;
}
