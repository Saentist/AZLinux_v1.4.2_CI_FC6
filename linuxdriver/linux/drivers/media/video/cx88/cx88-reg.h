...
#define MO_INT_I2CRACK		(1 << 17)
#define MO_INT_I2CDONE		(1 << 16)
#define MO_INT_DSTDMAINT	(1 <<  7)
#define MO_INT_SRCDMAINT	(1 <<  6)
#define MO_INT_TM1INT		(1 <<  5)
#define MO_INT_HSTINT		(1 <<  4)
#define MO_INT_VIPINT		(1 <<  3)
#define MO_INT_TSINT		(1 <<  2)
#define MO_INT_AUDINT		(1 <<  1)
#define MO_INT_VIDINT		(1 <<  0)
...
/* ----------------------------------------------------------------------------	*/
/* I2C Registers								*/
#define CX88_I2C		0x368000
#define CX88_I2C_DB0		(0xff << 24)
#define CX88_I2C_DB1		(0xff << 16)
#define CX88_I2C_DB2		(0xff <<  8)
#define CX88_I2C_MODE		(1 << 7)
#define CX88_I2C_RATE		(1 << 6)
#define CX88_I2C_NOSTOP		(1 << 5)
#define CX88_I2C_NOS1B		(1 << 4)
#define CX88_I2C_SYNC		(1 << 3)
#define CX88_I2C_W3BRA		(1 << 2)
#define CX88_I2C_SCL		(1 << 1)
#define CX88_I2C_SDA		(1 << 0)
